  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 md:px-6 md:py-24">
      ...
      <div className="mt-8 space-y-6 text-lg leading-relaxed text-muted-foreground">
        ...
        <p>
          Vi tror på att hålla det enkelt: bra bilder, ärliga beskrivningar och recensioner från riktiga gäster. Betalningen sker tryggt via Fjällportalen - utbetalningen till värden schemaläggs efter incheckning, så både gäst och värd vet att allt stämmer innan nyckeln byter hand.
        </p>
