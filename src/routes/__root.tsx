...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hitta och hyr stugor och lägenheter i Sälen, Åre, Vemdalen, Idre, Funäsdalen och hela svenska fjällkedjan — direkt från värd till gäst." },
      { name: "author", content: "Fjällhuset" },
      { property: "og:site_name", content: "Fjällhuset" },
      { property: "og:title", content: "Fjällhuset — Hyr stuga i svenska fjällen" },
      { property: "og:description", content: "Sveriges samlade plats för stuguthyrning i fjällen. Hyr eller hyr ut din stuga, direkt och tryggt." },
