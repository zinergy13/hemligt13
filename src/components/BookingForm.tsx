  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <p className="text-center text-[11px] text-muted-foreground">
        {instantBook
          ? "Direktbokning bekräftas omedelbart. Trygg betalning via Fjällportalen - utbetalningen till värden schemaläggs efter incheckning."
          : "Värden svarar inom 24 timmar. Trygg betalning via Fjällportalen - utbetalningen till värden schemaläggs efter incheckning."}
      </p>
    </form>
  );
}